  ...
  return (
    <div className="screen bg-ivory">
      ...
      <div className="scroll-area pb-nav">
        ...
        <ul className="mx-4 mt-3 rounded-2xl border border-border/60 bg-white/70 overflow-hidden">
            ...
            return (
              <li
                ...
                <button
                  ...
                  className="press w-full text-left p-4 border-b border-border/40 hover:bg-accent/5 transition-colors">
