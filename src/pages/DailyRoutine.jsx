...
const SECTIONS_SHIA = [
  { id:"morning", title:"Morning", arabic:"الصباح", icon:"sunrise",
    items: [
      { id:"wake_dua", label:"Wake-up du'a" },
      { id:"wudu", label:"Wudu" },
      { id:"morning_adhkar", label:"Morning adhkar" },
      { id:"dua_ahd", label:"Du'a al-Ahd" },
    ],
  },
  { id:"prayers", title:"Five prayers", arabic:"الصلوات", icon:"prayer",
    items: [
      { id:"fajr", label:"Fajr" },
      { id:"dhuhr", label:"Dhuhr" },
      { id:"asr", label:"Asr" },
  ...
  { id:"quran", title:"Qur'an", arabic:"القرآن", icon:"bookOpen",
    items: [
      { id:"quran_recite", label:"Read or recite Qur'an" },
      { id:"quran_reflect", label:"Reflect on a verse" },
    ],
  },
  { id:"dhikr", title:"Dhikr & du'a", arabic:"الذكر والدعاء", icon:"beads",
    items: [
      { id:"tasbih_zahra", label:"Tasbih al-Zahra (34/33/33)" },
      { id:"salawat", label:"Salawat on Muhammad & Aal Muhammad" },
      { id:"ziyarat", label:"Ziyarat (Ashura or short)" },
      { id:"personal_du", label:"Personal du'a" },
    ],
  },
  { id:"night", title:"Night", arabic:"الليل", icon:"moon",
    items: [
      { id:"evening_adhkar", label:"Evening adhkar" },
      { id:"salat_al_layl", label:"Salat al-Layl (if able)" },
      { id:"sleep_dua", label:"Sleep du'a" },
      { id:"muhasaba", label:"Muhasaba — review the day" },
    ],
  },
];
function getSections(branch) { return branch === "shia" ? SECTIONS_SHIA : SECTIONS_SUNNI; }
...
function computeStreak(history, TOTAL_ITEMS) {
  let streak = 0;
...
export default function DailyRoutine() {
  ...
  const SECTIONS = getSections(branch);
  ...
  const streak     = useMemo(() => computeStreak(history, TOTAL_ITEMS), [history, TOTAL_ITEMS]);
