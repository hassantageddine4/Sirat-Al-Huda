...
const ICONS = {
  ...
  // Mihrab — prayer niche, indicating qibla direction.
  mihrab: () => (
    <>
  ...
  // Refined kaaba with kiswa band across the top.
  kaaba: () => (
    <>
  ...
  // Tasbih — full circular ring of beads with small tassel detail.
  // Used for 99 Names of Allah. Contemplative, decorative.
  tasbih: () => (
    <>
      <circle cx="12" cy="11" r="6.5" {...stroke(1)} opacity="0.3" />
      <circle cx="12"   cy="4.5"  r="1.2" fill="currentColor" />
      <circle cx="16.6" cy="6.4"  r="1.0" fill="currentColor" />
      <circle cx="18.5" cy="11"   r="1.2" fill="currentColor" />
      <circle cx="16.6" cy="15.6" r="1.0" fill="currentColor" />
      <circle cx="12"   cy="17.5" r="1.2" fill="currentColor" />
      <circle cx="7.4"  cy="15.6" r="1.0" fill="currentColor" />
      <circle cx="5.5"  cy="11"   r="1.2" fill="currentColor" />
      <circle cx="7.4"  cy="6.4"  r="1.0" fill="currentColor" />
      <path d="M12 17.5v2.2" {...stroke(1.2)} />
      <path d="M10.8 19.7c0 1 .5 1.5 1.2 1.8.7-.3 1.2-.8 1.2-1.8" {...stroke(1.2)} />
    </>
  ),

  // Beads — for Dhikr Counter. Linear arc with counting indicator.
  // Visually distinct from tasbih (which is a full ring).
  beads: () => (
    <>
      <path d="M5 16q7-7 14 0" {...stroke(1.2)} opacity="0.4" />
      <circle cx="6"  cy="14.5" r="2"   {...stroke(1.5)} />
      <circle cx="12" cy="11.5" r="2.2" {...stroke(1.5)} />
      <circle cx="18" cy="14.5" r="2"   {...stroke(1.5)} />
      <path d="M12 5.5v3" {...stroke(1.5)} />
      <circle cx="12" cy="4" r="0.9" fill="currentColor" />
    </>
  ),

  // Waveform — vertical bars at varying heights, mic/recitation feel.
  waveform: () => (
    <>
      <path d="M4 12v0" {...stroke(2)} />
      <path d="M7 9.5v5"  {...stroke(2)} />
      <path d="M10 6v12"  {...stroke(2)} />
      <path d="M13 8v8"   {...stroke(2)} />
      <path d="M16 5.5v13" {...stroke(2)} />
      <path d="M19 9v6"   {...stroke(2)} />
      <path d="M22 11v2"  {...stroke(2)} />
    </>
  ),

  // Droplet — water droplet for Wudu Guide.
  droplet: () => (
    <>
      <path d="M12 3c-4 5-6 8-6 11a6 6 0 0 0 12 0c0-3-2-6-6-11z" {...stroke(1.5)} />
      <path d="M9 14c0 2 1 3 2 3.5" {...stroke(1.3)} opacity="0.6" />
    </>
  ),

  // Du'a Book — open book with light/illumination above.
  // Used for Daily Duas. The light reads as supplications rising / illumination.
  duaBook: () => (
    <>
      {/* Light above the book */}
      <circle cx="12" cy="4.5" r="1" fill="currentColor" />
      <path d="M12 1.6 L 12 2.7" {...stroke(1.2)} />
      <path d="M9.5 3 L 10.2 3.7" {...stroke(1.2)} />
      <path d="M14.5 3 L 13.8 3.7" {...stroke(1.2)} />
      {/* Left page */}
      <path d="M3 11 L 3 19 L 11.4 19 L 11.4 12 Q 11.4 11 10.6 10.7 Q 7 9.4 3 10.6 Z" {...stroke(1.5)} />
      {/* Right page */}
      <path d="M21 11 L 21 19 L 12.6 19 L 12.6 12 Q 12.6 11 13.4 10.7 Q 17 9.4 21 10.6 Z" {...stroke(1.5)} />
      {/* Subtle text lines on each page */}
      <path d="M5.5 13.2 L 9 13.2" {...stroke(1)} opacity="0.55" />
      <path d="M5.5 15.4 L 8.2 15.4" {...stroke(1)} opacity="0.55" />
      <path d="M15 13.2 L 18.5 13.2" {...stroke(1)} opacity="0.55" />
      <path d="M15.8 15.4 L 18.5 15.4" {...stroke(1)} opacity="0.55" />
    </>
  ),

  // Checklist — tablet with three lines, top two checked, third unchecked.
  // Used for Daily Routine.
  checklist: () => (
    <>
      <rect x="4" y="4" width="16" height="16" rx="2.5" {...stroke(1.5)} />
      <path d="M7.5 9l1.3 1.3 2.2-2.2" {...stroke(1.6)} />
      <path d="M13 9.2h4" {...stroke(1.5)} />
      <path d="M7.5 13l1.3 1.3 2.2-2.2" {...stroke(1.6)} />
      <path d="M13 13.2h4" {...stroke(1.5)} />
      <circle cx="8.5" cy="17.2" r="1.2" {...stroke(1.4)} />
      <path d="M11 17.2h4" {...stroke(1.5)} />
    </>
  ),
  ...
  // bookOpen — refined open book for Islam Basics.
  // Shares the curve language with duaBook so they read as a family,
  // but no light above and no text lines — clean and architectural.
  bookOpen: () => (
    <>
      {/* Left page */}
      <path d="M3 8 L 3 18 L 11.4 18 L 11.4 9 Q 11.4 8 10.6 7.7 Q 7 6.4 3 7.6 Z" {...stroke(1.5)} />
      {/* Right page */}
      <path d="M21 8 L 21 18 L 12.6 18 L 12.6 9 Q 12.6 8 13.4 7.7 Q 17 6.4 21 7.6 Z" {...stroke(1.5)} />
      {/* Spine connector */}
      <path d="M11.4 9 L 12 8.4 L 12.6 9" {...stroke(1.4)} />
      {/* Faint ground line */}
      <path d="M2 19 L 22 19" {...stroke(1.2)} opacity="0.35" />
    </>
  ),
  ...
  scales: () => (
    <>
      <path d="M12 4v16M5 21h14" {...stroke(1.6)} />
      <path d="M5 9h6M13 9h6" {...stroke(1.4)} />
      <path d="M5 15c0-3 1.5-6 3-6s3 3 3 6H5zM13 15c0-3 1.5-6 3-6s3 3 3 6h-6z" {...stroke(1.4)} />
    </>
  ),
