...
function PermissionRow({ iconName, label, description, status, last }) {
  const config = {
        ...
        {tab === "settings" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              ...
              <Card style={{ overflow: "hidden" }}>
                <RowItem iconName="globe" label="Language" sub={userProfile.language ?? "English"}
                  onPress={() => navigate("/account/language")} last />
              </Card>
            </div>
            ...
            <div>
              ...
              <Card style={{ overflow: "hidden" }}>
                {/* Prayer Notifications master toggle (functional, not just status) */}
                <div className="flex items-center gap-3 px-4"
