  ...
  return (
    <LegalDocLayout title="Privacy Policy" lastUpdated={LAST_UPDATED}>
      ...
      <Section title="4. Service providers">
        <p>
          We use the following third-party services to operate Sirat. Each
          processes only the minimum data necessary for its role:
        </p>
        <Bullets items={[
          "Supabase — authentication, account database. Privacy policy at supabase.com/privacy.",
          "Quran.com — Qur'an text, translations, recitation audio. We send only chapter/verse identifiers.",
          "AlAdhan API — Hijri calendar conversion. We send only date strings, never your account information.",
          "fawazahmed0/hadith-api (jsDelivr CDN) — hadith content. Served as static files; no personal data is exchanged.",
          "Apple — App Store distribution, sign-in with Apple, push notification delivery (if used).",
        ]} />
      </Section>
