...
export function ReciterSheet({ onClose }) {
  ...
  return (
    ...
    >
      <div className="w-full rounded-t-3xl overflow-hidden flex flex-col animate-fade-in"
        style={{ background: "#0F1B14", maxHeight: "75vh" }}>
            ...
            return (
              <button
                ...
                <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0"
                  ...
                  <span style={{ fontSize: 16, color: active ? "#082819" : "rgba(255,255,255,0.7)" }}>🎧</span>
                </div>
                <div className="flex-1 min-w-0">
