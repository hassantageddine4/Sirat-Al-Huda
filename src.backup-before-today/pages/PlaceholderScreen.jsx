...
const MODULE_META = {
  "wudu"    : { title: "Wudu Guide",          icon: "💧", desc: "Step-by-step purification guide before prayer." },
  "duas"    : { title: "Daily Duas",           icon: "🤲", desc: "Morning, evening, and situational supplications." },
  "names"   : { title: "99 Names of Allah",   icon: "✨", desc: "Learn and reflect on the beautiful names of Allah." },
  "routine" : { title: "Daily Routine",       icon: "☀️", desc: "Build and track your daily acts of worship." },
  "hadith"  : { title: "Hadith Collection",   icon: "📚", desc: "Read and reflect on authentic hadith." },
  "prophets": { title: "Prophets & Imams",    icon: "🌟", desc: "Stories and lessons from the lives of the prophets." },
  "surah"   : { title: "Surah Reader",        icon: "📖", desc: "Read and listen to the full surah." },
  "juz"     : { title: "Juz Reader",          icon: "📖", desc: "Read this Juz with translation." },
  "progress": { title: "My Progress",        icon: "📊", desc: "Track your streaks and achievements over time." },
};
