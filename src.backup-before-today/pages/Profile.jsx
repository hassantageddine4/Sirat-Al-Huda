...
const ACHIEVEMENTS = [
  { id: "first7",    icon: "🌱", title: "First Week",    desc: "7-day streak",       earned: true  },
  { id: "consistent",icon: "⭐", title: "Consistent",    desc: "14-day streak",       earned: true  },
  { id: "fajr7",     icon: "🌅", title: "Fajr Warrior",  desc: "7 Fajr in a row",    earned: true  },
  { id: "30days",    icon: "🏆", title: "30 Days",       desc: "30-day streak",       earned: false },
  { id: "allprayers",icon: "🕌", title: "All 5 Daily",   desc: "All 5 prayers/day x7", earned: false },
  { id: "journal7",  icon: "📓", title: "Reflective",    desc: "7 journal entries",  earned: false },
];

const GOALS_DEFAULT = [
  { id: "fard",   label: "Pray all 5 prayers",   progress: 60, icon: "🕌" },
  { id: "streak", label: "Maintain daily streak", progress: 100, icon: "🔥" },
  { id: "duas",   label: "Read daily duas",       progress: 40, icon: "🤲" },
  { id: "quran",  label: "Quran 10 min/day",      progress: 75, icon: "📖" },
];
...
function RowItem({ icon, label, sub, chevron = true, onPress, last, right, danger }) {
  return (
...
// ─── Quran Verse Preview (used inside Settings tab) ──────────────────────────
...
export default function Profile() {
  ...
  // Completed today (hardcoded for display; real: from prayer state)
  const todayDone = 3;
  ...
  // Notification handlers are provided by usePrayerNotifications hook
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right">
                    <span style={{ fontSize: 11, fontWeight: 700, padding: "5px 10px",
                      ...
                      {todayDone === 5 ? "Completed ✓" : todayDone >= 3 ? "On track" : "Catch up"}
                    </span>
                        ...
                        <div style={{ width: "100%", height: 60,
                          ...
                          <div style={{ width: "100%", height: barH, borderRadius: 8,
                                        background: isToday
                                          ...
                                          : v === 5 ? "rgba(15,61,46,0.5)" : "rgba(15,61,46,0.25)",
            ...
            <div>
              ...
              <Card style={{ overflow: "hidden" }}>
                <RowItem icon="📓" label="My Journal"     sub="Private reflections"          onPress={() => navigate("/journal")} />
                <RowItem icon="🧭" label="Qibla Compass"  sub="Find direction of the Kaaba"  onPress={() => navigate("/qibla")}   />
                <RowItem icon="👨‍🏫" label="Ask a Scholar"  sub="imam-us.org"                  onPress={() => window.open("https://imam-us.org","_blank","noopener")} />
                <RowItem icon="📊" label="My Progress"    sub="Streaks and achievements"      onPress={() => navigate("/progress")} last />
              </Card>
            </div>
        ...
        {tab === "settings" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              ...
              <Card style={{ overflow: "hidden" }}>
                <RowItem icon="👤" label="Edit Profile"    sub={name}              onPress={() => navigate("/settings")} />
                <RowItem icon="📧" label="Email Address"   sub={email || "Not set"} onPress={() => navigate("/settings")} />
                <RowItem icon="🔑" label="Change Password" sub="Update your password" onPress={() => navigate("/settings")} last />
              </Card>
            </div>
            ...
            <div>
              ...
              <Card style={{ overflow: "hidden" }}>
                ...
                <RowItem icon="🌐" label="Language" sub={userProfile.language ?? "English"}
            ...
            {/* Prayer Reminders — per-prayer live toggles + real times */}
            <div>
              ...
              <Card style={{ overflow: "hidden", opacity: prefs.notifEnabled ? 1 : 0.55 }}>
                {["Fajr","Dhuhr","Asr","Maghrib","Isha","Tahajjud"].map((name, i) => {
                  ...
                  const meta   = PRAYER_ARABIC[name] ?? { emoji: "🕌" };
                  const isLast = i === 5;
                  return (
                    <div key={name}
                      ...
                      {/* Offset selector — only show if prayer is ON */}
            ...
            <div>
              ...
              <Card style={{ overflow: "hidden" }}>
                ...
                <RowItem icon="📍" label="Prayer Time Location"
            ...
            <div>
              ...
              <Card style={{ overflow: "hidden" }}>
                <RowItem icon="🚪" label="Sign Out" onPress={handleSignOut} danger />
                <RowItem icon="🗑️" label="Delete Account" sub="Permanently remove your data"
