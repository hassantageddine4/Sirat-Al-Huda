...
function prayerBody(prayer, offsetMin) {
  if (offsetMin > 0) {
    return `${prayer} prayer in ${offsetMin} minutes. Prepare for prayer.`;
  }
  // Calm spiritual copy that rotates per prayer
  const messages = {
    Fajr:    [
      "The dawn of barakah. Begin your day with prayer.",
      "Fajr has begun. The best beginning is remembrance of Allah.",
      "Start your day standing before Allah.",
    ],
    Dhuhr: [
      "Pause and reconnect with Allah.",
      "Dhuhr prayer has begun. Take a moment of stillness.",
      "Step away from the world; turn toward Allah.",
    ],
    Asr: [
      "Asr prayer has begun. Do not let the day pass without prayer.",
      "The afternoon calls — return to your Lord.",
      "Time for Asr. Find your rhythm in remembrance.",
    ],
    Maghrib: [
      "As the sun sets, remember Allah.",
      "Maghrib has arrived. End the day with gratitude.",
      "The day folds gently; bow before your Lord.",
    ],
    Isha: [
      "End your day with prayer.",
      "Isha has begun. Close your day in remembrance.",
      "The night invites stillness. Pray Isha and find peace.",
    ],
  };
  const arr = messages[prayer] ?? [`${prayer} prayer has begun.`];
  // Day-of-year-based selection so a given day picks the same message consistently
